...
class $AssetsFontsGen {
  ...
  List<String> get values =>
      [montserratBold, montserratLight, montserratRegular];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/tif.png
  AssetGenImage get tif => const AssetGenImage('assets/images/tif.png');

  /// List of all assets
  List<AssetGenImage> get values => [tif];
}
